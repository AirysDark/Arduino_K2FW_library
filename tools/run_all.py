...
def main():
    ...
    run([sys.executable, str(repo/"tools/extract_paths.py"), str(dump_root), str(out_dir/"Paths.json")])
    run([sys.executable, str(repo/"tools/extract_prompts.py"), str(dump_root), str(out_dir/"Prompts.json")])
    run([sys.executable, str(repo/"tools/extract_signatures.py"), str(dump_root), str(out_dir/"Signatures.json")])
